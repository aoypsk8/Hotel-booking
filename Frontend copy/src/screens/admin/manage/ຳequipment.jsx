...
import { DeleteEquipment, GetAllEquipment } from "../../../api/equipment/equipmentAction";
                    ...
                    <tbody className="bg-white">
                        {currentItems.map((item) => (
                            <tr key={item.id}>
                                ...
                                <td className="border border-btnn border-opacity-50 px-4 py-2 text-center font-light">{format(new Date(item.datecreate), "dd/MM/yyyy HH:mm:ss")}</td>
                                        ...
                                        onClick={() => {
                                            Swal.fire({
                                                ...
                                                if (result.isConfirmed) {
                                                    dispatch(DeleteEquipment(item.EquipmentID));
                                                }
                                            });
                                        }}
                                    >
